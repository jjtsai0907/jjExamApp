...
object DataManager {
    ...
    fun createMockData(){
        //done
        nations.add(NationClass("Hong Kong", 4300, mutableListOf(
        ...
        //done
        nations.add(NationClass("Taiwan", 5500, mutableListOf(
            QuestionClass("Taiwan has the land size of Belgium. Belgium has 11 million residents. How many people live in Taiwan?", "23 million", "10 million", "17 million", "19 million", LatLng(24.2616609,120.5543753)),
            QuestionClass("Which of the following is the first and currently only country that legalises gay marriage in Asia?", "Taiwan", "Japan", "South Korea", "China", LatLng(24.1572335,120.6638719)),
            QuestionClass("Which of the following has never 'colonised/ruled' Taiwan?","UK", "China", "Spain", "Netherlands", LatLng(21.9326293,120.7415405)),
            QuestionClass("Taiwan constructed one building that was once the tallest in the world. What's it called?", "Taipei 101", "Taiwan 101", "Taipei 100", "Taiwan 100", LatLng(24.4164556,121.5119348)),
            QuestionClass("Which of the following country 'strives' not only to discriminate Taiwan's democracy and autonomy, but also threatening to start wars?", "China", "USA", "Czech Republic", "UK", LatLng(25.033976,121.5623502)))))

        //done
        nations.add(NationClass("Japan", 5500, mutableListOf(
