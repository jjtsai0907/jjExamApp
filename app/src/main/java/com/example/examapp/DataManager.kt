...
object DataManager {
    ...
    fun createMockData(){
        ...
        nations.add(NationClass("Hong Kong", 4300,R.drawable.ticket, mutableListOf(
        ...
        nations.add(NationClass("Taiwan", 0,R.drawable.ticket, mutableListOf(
            ...
            QuestionClass("Which of the following country 'strives' not only to discriminate Taiwan's democracy and autonomy, but also threatening to start wars?", "China", "USA", "Czech Republic", "UK", LatLng(25.033976,121.5623502), "Taipei", R.drawable.iceland)),false, true, "TW"))
        ...
        nations.add(NationClass("Japan", 0,R.drawable.ticket ,mutableListOf(
            ...
            QuestionClass("Which of the following is the Capital of Japan?", "Tokyo", "Osaka", "Nagoya", "Sapporo", LatLng(39.738913,141.3488523), "Iwate")), false, true, "JP"))
        ...
        nations.add(NationClass("USA", 0, R.drawable.ticket, mutableListOf(
            ...
            QuestionClass("South Kaibab Trail is one of the popular trails to hike down to Colorado River from Rim, and it is 11.4 km long. How many water stops on the way?", "0", "Depends on Seasons", "3", "8", LatLng(36.073353,-112.0930617), "Grand Canyon")), false, true, "USA"))
        ...
        nations.add(NationClass("Russia", 1700, R.drawable.ticket, mutableListOf(
        ...
        nations.add(NationClass("Norway", 200, R.drawable.ticket,mutableListOf(
        ...
        nations.add(NationClass("Iceland", 1100, R.drawable.ticket,mutableListOf(
