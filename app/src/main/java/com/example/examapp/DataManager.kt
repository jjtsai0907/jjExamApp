...
object DataManager {
    ...
    fun createMockData(){
        ...
        nations.add(NationClass("Peru", 0,R.drawable.ticket, mutableListOf(
            ...
            QuestionClass("The height of Machu Picchu?", "2,430 m", "2,630 m", "2,530 m", "2,730 m", LatLng(-13.163237, -72.544842), "Machu Picchu", R.drawable.peru4))))

        // Q done
        nations.add(NationClass("Taiwan", 0,R.drawable.ticket, mutableListOf(
            ...
            QuestionClass("Taiwan current have a female president, at what year was she elected to office?", "2016", "2017", "2018", "2019", LatLng(25.033976,121.5623502), "Taipei", R.drawable.iceland)),"TW"))

        // Q done
        nations.add(NationClass("Japan", 0,R.drawable.ticket ,mutableListOf(
            ...
            QuestionClass("Which of the following is the Capital of Japan?", "Tokyo", "Osaka", "Nagoya", "Sapporo", LatLng(39.738913,141.3488523), "Iwate")),  "JP"))

        // Q done
        nations.add(NationClass("USA", 0, R.drawable.ticket, mutableListOf(
            ...
            QuestionClass("Which of the following is one of the three sister cities of Fargo's??", "Vimmerby", "Trollhättan", "Karlstad", "Sundsvall", LatLng(46.8541125,-96.9685994), "Fargo"),
        ...
        nations.add(NationClass("Mongolia", 0, R.drawable.ticket, mutableListOf(
            ...
            QuestionClass("Morin khuur is a traditional Mongolian musical instrument. What type of instrument is it?", "Strings", "Vocal", "Brass", "Percussion", LatLng(47.818348, 106.966224), "Bogd Khan", R.drawable.mongolia2))))

        // Q done
        nations.add(NationClass("Russia", 0, R.drawable.ticket, mutableListOf(
            QuestionClass("The first McDonald's in Russian was opened on Jan 31, 1990. The amount of customers served during a single day still remains the world record. How many people on that day?", "30,000", "10,000", "5,000", "3,600", LatLng(55.765532, 37.605850), "Pushkin Square, Moscow"),
            QuestionClass("Dogs in Moscow are not allowed to bark at night. When?", "11pm - 7am", "10pm - 6am", "No Such a Rule", "12pm - 6am", LatLng(55.750981, 37.617209),"Moscow", R.drawable.russia1),
            ...
            QuestionClass("Russia is home to the deepest lake in the world. How many % of the world's fresh water it contains?", "20 %", "70 %", "22 %", "12 %", LatLng(53.4045986,108.1260905), "Lake Baikal", R.drawable.russia3))))


        // Q done
        nations.add(NationClass("Norway", 0, R.drawable.ticket,mutableListOf(
            ...
            QuestionClass("Which Nobel Prize is awarded in Oslo?", "Peace Prize", "Literature Prize", "Physics Prize", "Chemistry Prize", LatLng(59.9138453,10.7521148), "Oslo", R.drawable.norway1))))

        // Q done
        nations.add(NationClass("Germany", 0, R.drawable.ticket, mutableListOf(
            ...
            QuestionClass("Hamburg has a very large harbour, it's Europe's __ largest", "3rd", "1st", "2nd", "4th", LatLng(53.5451198,9.9818934), "Hamburg", R.drawable.hamburg))))

        // Q done, pics left
        nations.add(NationClass("Iceland", 0, R.drawable.ticket,mutableListOf(
            ...
            QuestionClass("Beer was illegal in Iceland until year ___ ?", "1989", "1993", "1458", "1901", LatLng(64.1335484,-21.9224814),"Reykjavik"),
            QuestionClass("How does Iceland smell like?", "Fart", "Rose", "Banana", "Deer", LatLng(64.3137852,-20.2996613), "Geysir"),
            QuestionClass("Iceland has only waged one war, and it can barely be called war. Which nation was it against?", "UK", "USA", "Green Land", "Denmark", LatLng(63.4376879,-20.2760758), "Vestmannaeyjar"),
            QuestionClass("How many railway lines are there in Iceland?", "0", "5", "3", "2", LatLng(65.679733,-18.0940219,), "Akureyri"))))
    }
}