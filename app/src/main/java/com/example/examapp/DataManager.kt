...
object DataManager {
    ...
    fun createMockData(){
        ...
        nations.add(NationClass("Peru", 150,R.drawable.ticket, mutableListOf(
            ...
            QuestionClass("The height of Machu Picchu?", "2,430 m", "2,630 m", "2,530 m", "2,730 m", LatLng(-13.163237, -72.544842), "Machu Picchu", R.drawable.peru4)),"PER", 4))
        ...
        nations.add(NationClass("Taiwan", 200, R.drawable.twn, mutableListOf(
            ...
            QuestionClass("Taiwan current have a female president, at what year was she elected to office?", "2016", "2017", "2018", "2019", LatLng(25.033976,121.5623502), "Taipei", R.drawable.taipei)),"TWN", 5))
        ...
        nations.add(NationClass("Japan", 100, R.drawable.jpn ,mutableListOf(
            ...
            QuestionClass("Which of the following is the Capital of Japan?", "Tokyo", "Osaka", "Nagoya", "Sapporo", LatLng(39.738913,141.3488523), "Iwate", R.drawable.japan2)),  "JPN", 5))
        ...
        nations.add(NationClass("USA", 20, R.drawable.usaticket, mutableListOf(
            ...
            QuestionClass("South Kaibab Trail is one of the popular trails to hike down to Colorado River from Rim, and it is 11.4 km long. How many water stops on the way?", "0", "Depends on Seasons", "3", "8", LatLng(36.073353,-112.0930617), "Grand Canyon",R.drawable.gc)), "USA", 7))
        ...
        nations.add(NationClass("Mongolia", 6500, R.drawable.mng, mutableListOf(
            ...
            QuestionClass("Morin khuur is a traditional Mongolian musical instrument. What type of instrument is it?", "Strings", "Vocal", "Brass", "Percussion", LatLng(47.818348, 106.966224), "Bogd Khan", R.drawable.mongolia2)), "MNG", 4))
        ...
        nations.add(NationClass("Russia", 2100, R.drawable.rus, mutableListOf(
            ...
            QuestionClass("Russia is home to the deepest lake in the world. How many % of the world's fresh water it contains?", "20 %", "70 %", "22 %", "12 %", LatLng(53.4045986,108.1260905), "Lake Baikal", R.drawable.russia3)), "RUS", 4))
        ...
        nations.add(NationClass("Norway", 350, R.drawable.nor,mutableListOf(
            ...
            QuestionClass("Which Nobel Prize is awarded in Oslo?", "Peace Prize", "Literature Prize", "Physics Prize", "Chemistry Prize", LatLng(59.9138453,10.7521148), "Oslo", R.drawable.norway1)), "NOR", 2))
        ...
        nations.add(NationClass("Germany", 550, R.drawable.deu, mutableListOf(
            ...
            QuestionClass("Hamburg has a very large harbour, it's Europe's __ largest", "3rd", "1st", "2nd", "4th", LatLng(53.5451198,9.9818934), "Hamburg", R.drawable.hamburg)), "DEU", 3))
        ...
        nations.add(NationClass("Iceland", 1700, R.drawable.isl,mutableListOf(
            ...
            QuestionClass("How many railway lines are there in Iceland?", "0", "5", "3", "2", LatLng(65.679733,-18.0940219,), "Akureyri", R.drawable.iceland4)), "ISL", 5))
    }
}